# Generated by Django 3.2.5 on 2021-07-02 15:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('study_applicants', models.ManyToManyField(blank=True, related_name='study_applicants', to=settings.AUTH_USER_MODEL, verbose_name='스터디 지원자')),
                ('study_members', models.ManyToManyField(blank=True, related_name='study_members', to=settings.AUTH_USER_MODEL, verbose_name='스터디 멤버')),
            ],
        ),
        migrations.CreateModel(
            name='Profile',
            fields=[
                ...
                ('validations', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='validations', to='agongda.validation', verbose_name='인증 수준')),
            ],
        ),
    ]
